#!/usr/bin/env bash
# Auto-generated runner script for coder agent
...
agents.append({'name': 'coder', 'role': 'coder', 'status': 'working', 'current_task': '', 'session_start': '${NOW}', 'last_heartbeat': '${NOW}'})
reg['agents'] = agents
...
exec claude \
  ...
  -p "You are the coder agent. Read .claude/coordination/TASKS.md and begin working on your assigned tasks. Update task status as you progress."
