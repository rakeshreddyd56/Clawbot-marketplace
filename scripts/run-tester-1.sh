#!/usr/bin/env bash
# Auto-generated runner script for tester-1 agent
...
agents.append({'name': 'tester-1', 'role': 'tester-1', 'status': 'working', 'current_task': '', 'session_start': '${NOW}', 'last_heartbeat': '${NOW}'})
reg['agents'] = agents
...
exec claude \
  ...
  -p "You are the tester-1 agent. Read .claude/coordination/TASKS.md and begin working on your assigned tasks. Update task status as you progress."
