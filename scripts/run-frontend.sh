#!/usr/bin/env bash
# Auto-generated runner script for frontend agent
...
agents.append({'name': 'frontend', 'role': 'frontend', 'status': 'working', 'current_task': '', 'session_start': '${NOW}', 'last_heartbeat': '${NOW}'})
reg['agents'] = agents
...
exec claude \
  ...
  -p "You are the frontend agent. Read .claude/coordination/TASKS.md and begin working on your assigned tasks. Update task status as you progress."
